...
/*
 * Copyright (c) 1989-1002,1996-1997,2001,2004-2006, 2009-2010 Wind River Systems, Inc.
 *
...
02k,24feb09,jmp  64-bit support: Defined SYM_VALUE, SYM_GROUP, SYM_REF types.
02j,20jan06,v_r  Fixed SPR#110049 (symbol group changed from UINT16 to
                 UINT32).
02i,07mar05,v_r  Cleanups + code conventions compliancy work.
		 Moved SYMBOL struct here as it's needed by published APIs.
02h,18sep04,jn   Apply code review changes
02g,01apr04,jn   Change values of symbol type macros.  Symbol types
